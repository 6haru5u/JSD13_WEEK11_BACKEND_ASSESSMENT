...
ใช้ `MY_UNDERSTANDING_TEMPLATE.md` เป็นจุดเริ่มต้น — copy ไฟล์นั้นเข้าไปในโปรเจกต์ของคุณ เปลี่ยนชื่อเป็น `my-understanding.md` แล้วตอบทุกคำถามด้วยคำพูดของคุณเอง
